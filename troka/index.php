...
?>
    ...
    <header class="header">
      ...
      <div class="titre">
        <h1>BIENVENUE SUR <span>TROKI</span>TROKA !</h1>
      </div>
      <!-- CREATION DU BOUTON "LET'S TROK"-->
      <div class="btn">
        <a href="<?php echo $connexionaddr; ?>">LET'S TROK</a>
      </div>
      <!-- FIN DE LA CREATION DU BOUTON "LET'S TROK" -->
    </header>
    <img src="/medias/newaccueil.png" width="auto" height="540px"/>
    <!-- AJOUT DU FOOTER -->
    <footer id="footer" class="section footer"><div class="container">
      <div class="footer-container">
	      ...
	      <div class="footer-center">
		      <h3>CONTACTE NOUS</h3>
		        <div>
			        <span><i class="fa fa-map-marker-alt"></i></span>Marseille
		        </div>
		        <div>
			        <span><i class="fa fa-envelope"></i></span>@gmail
            </div>
		        <div>
              <span><i class="fa fa-phone"></i></span>0783...
		        </div>
		        <div>
			        <span><i class="fa fa-paper-plane"></i></span>France
	        	</div>
	        </div>
        </div>
      </div>
